    ...
    approvals: [
      {
        ...
        level: 1,
        status: "approved",
        notes: "Disetujui Leader",
        decided_at: getTimestamp(getDateString(18), "08:00"),
      ...
      },
      {
        ...
        created_at: getTimestamp(getDateString(18), "08:00"),
      }
    ],
    created_at: getTimestamp(getDateString(19), "14:00"),
    ...
    approvals: [
      {
        ...
        level: 1,
        status: "approved",
        notes: "Disetujui, terima kasih atas kerja kerasnya",
        decided_at: getTimestamp(getDateString(16), "08:00"),
      ...
      },
      {
        ...
        status: "approved",
        notes: "Disetujui HR",
        decided_at: getTimestamp(getDateString(16), "09:00"),
        created_at: getTimestamp(getDateString(16), "08:00"),
      }
    ],
    created_at: getTimestamp(getDateString(17), "16:00"),
    ...
    approvals: [
      {
        ...
        level: 1,
        status: "rejected",
        notes: "Tidak disetujui, durasi terlalu lama. Silakan ajukan ulang dengan durasi yang lebih wajar atau split menjadi beberapa hari.",
        decided_at: getTimestamp(getDateString(20), "09:00"),
